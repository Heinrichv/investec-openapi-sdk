...
namespace Investec.Sdk.OpenApi.Clients
{
    public class InvestecOpenApiService : IInvestecOpenApiService
    {
        ...
        {
            HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Get, $"za/pb/v1/accounts/{accountId}/transactions");
        ...
        {
            HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Get, $"za/pb/v1/accounts/{accountId}/balance");
